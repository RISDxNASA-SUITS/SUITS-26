...
EVA_JAVA_BACKEND_URL=http://localhost:7070
...
- [`docs/DEMO_GUIDE.md`](docs/DEMO_GUIDE.md) — Demo usage guide (English) for presenters and testers.
- [`docs/DEMO_GUIDE.zh-CN.md`](docs/DEMO_GUIDE.zh-CN.md) — Same guide in **中文**.
