...
export const evData = {
  ...
  vitals: [
    ...
    { label: "SpO2 (Oxygen Saturation)", value: "97", unit: "%", trend: "stable", tone: "teal" },
    { label: "Core Body Temperature", value: "98", unit: "deg F", trend: "up", tone: "green" },
    { label: "RR (Respiration Rate)", value: "17", unit: "Breaths/Min", trend: "down", tone: "magenta" },
  ],
}
